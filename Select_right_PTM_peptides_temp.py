...
inputfile3 = open ('PTM_to_be_selected_2.txt','r')
...
#    prog.prog(num111,oneper)
    ...
    for xx in tempptmlist:
        ...
        if len(tryppep111) == 15 and pos111 >30 and pos111 < 70 and 'P' not in tryppep111 and 'M' not in tryppep111 and 'kTNGGCPICK' not in tryppep111 and 'mMLGPEGGEGFVVK' not in tryppep111:
    ...
    if len(temp_select_list) < 1:
        ...
        for xx in tempptmlist:
            ...
            if len(xx_ls) <15:
                ...
                pos111 = int(float(x_ls[14].strip()))
            tryppep111 = xx_ls[11].strip()        
            if len(tryppep111) >= 10 and len(tryppep111) <= 20 and pos111 >30 and pos111 < 70 and 'P' not in tryppep111 and 'M' not in tryppep111 and 'kTNGGCPICK' not in tryppep111 and 'mMLGPEGGEGFVVK' not in tryppep111:
                temp_select_list.append(xx)
        if len(temp_select_list) < 1:
            temp_select_list = []
            for xx in tempptmlist:
                ...
                if len(xx_ls) <15:
                    ...
                    pos111 = int(float(x_ls[14].strip()))                
                tryppep111 = xx_ls[11].strip()        
                if len(tryppep111) >= 10 and len(tryppep111) <= 20 and pos111 >30 and pos111 < 70 and 'P' not in tryppep111 and 'kTNGGCPICK' not in tryppep111 and 'mMLGPEGGEGFVVK' not in tryppep111:
                    temp_select_list.append(xx)
            if len(temp_select_list) < 1:
                temp_select_list = []
                for xx in tempptmlist:
                    ...
                    if len(xx_ls) <15:
                        ...
                        pos111 = int(float(x_ls[14].strip()))                    
                    tryppep111 = xx_ls[11].strip()        
                    if len(tryppep111) >= 10 and len(tryppep111) <= 20 and pos111 >30 and pos111 < 70 and 'kTNGGCPICK' not in tryppep111 and 'mMLGPEGGEGFVVK' not in tryppep111 :
                        temp_select_list.append(xx)            
                if len(temp_select_list) < 1:
                    temp_select_list = []
                    for xx in tempptmlist:
                        ...
                        acc111 = xx_ls[1].strip()
                        tryppep111 = xx_ls[11].strip()        
                        if len(tryppep111) >= 8 and len(tryppep111) <= 25 and 'kTNGGCPICK' not in tryppep111 and 'mMLGPEGGEGFVVK' not in tryppep111:
                            temp_select_list.append(xx)                      
                    if len(temp_select_list) < 1:
