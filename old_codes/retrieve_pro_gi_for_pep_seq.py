...
for y in read1:
    ...
    elapsed = end - start
    elapsed_round = round(elapsed,0)
    current_line_elapsed_time =  'Current line is ' + str(j) + '   Elapsed time is ' + str(elapsed_round) + ' sec' + "\r"
    sys.stdout.write(current_line_elapsed_time)
    sys.stdout.flush()    
...
#    outputfile.write(newline)
    for eachkey in dic.keys():
        if y_strip in eachkey:
            ...
            gi1 = gi_len1[0]
            len1 = gi_len1[1]
            result = y_strip + "|" + value + "|" + seq_pos_str + ";"
#            print result
